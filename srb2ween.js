...
// include: C:\Users\finli\AppData\Local\Temp\tmpb6l2hdcg.js
  ...
  (() => {
    ...
    loadPackage({"files": [{"filename": "/autoexec.cfg", "start": 0, "end": 44}, {"filename": "/config.cfg", "start": 44, "end": 2590}, {"filename": "/doom2.wad", "start": 2590, "end": 6517258}, {"filename": "/doom3.wad", "start": 6517258, "end": 7388930}], "remote_package_size": 7388930});

  })();

// end include: C:\Users\finli\AppData\Local\Temp\tmpb6l2hdcg.js
// include: C:\Users\finli\AppData\Local\Temp\tmpqwkdkf0z.js

    // All the pre-js content up to here must remain later on, we need to run
    // it.
    if ((typeof ENVIRONMENT_IS_WASM_WORKER != 'undefined' && ENVIRONMENT_IS_WASM_WORKER) || (typeof ENVIRONMENT_IS_PTHREAD != 'undefined' && ENVIRONMENT_IS_PTHREAD) || (typeof ENVIRONMENT_IS_AUDIO_WORKLET != 'undefined' && ENVIRONMENT_IS_AUDIO_WORKLET)) Module['preRun'] = [];
    var necessaryPreJSTasks = Module['preRun'].slice();
  // end include: C:\Users\finli\AppData\Local\Temp\tmpqwkdkf0z.js
// include: C:\Users\finli\AppData\Local\Temp\tmp5uvp86j4.js

    if (!Module['preRun']) throw 'Module.preRun should exist because file support used it; did a pre-js delete it?';
    necessaryPreJSTasks.forEach((task) => {
      if (Module['preRun'].indexOf(task) < 0) throw 'All preRun tasks that exist before user pre-js code should remain after; did you replace Module or modify Module.preRun?';
    });
  // end include: C:\Users\finli\AppData\Local\Temp\tmp5uvp86j4.js
...
var ASM_CONSTS = {
 ...
 421068: ($0, $1, $2, $3, $4) => { var w = $0; var h = $1; var hot_x = $2; var hot_y = $3; var pixels = $4; var canvas = document.createElement("canvas"); canvas.width = w; canvas.height = h; var ctx = canvas.getContext("2d"); var image = ctx.createImageData(w, h); var data = image.data; var src = pixels / 4; var dst = 0; var num; if (typeof CanvasPixelArray !== 'undefined' && data instanceof CanvasPixelArray) { num = data.length; while (dst < num) { var val = HEAP32[src]; data[dst ] = val & 0xff; data[dst+1] = (val >> 8) & 0xff; data[dst+2] = (val >> 16) & 0xff; data[dst+3] = (val >> 24) & 0xff; src++; dst += 4; } } else { var data32 = new Int32Array(data.buffer); num = data32.length; data32.set(HEAP32.subarray(src, src + num)); } ctx.putImageData(image, 0, 0); var url = hot_x === 0 && hot_y === 0 ? "url(" + canvas.toDataURL() + "), auto" : "url(" + canvas.toDataURL() + ") " + hot_x + " " + hot_y + ", auto"; var urlBuf = _malloc(url.length + 1); stringToUTF8(url, urlBuf, url.length + 1); return urlBuf; },  
 422056: ($0) => { if (Module['canvas']) { Module['canvas'].style['cursor'] = UTF8ToString($0); } },  
 422139: () => { if (Module['canvas']) { Module['canvas'].style['cursor'] = 'none'; } },  
 422208: () => { return window.innerWidth; },  
 422238: () => { return window.innerHeight; }
};
