...
// include: C:\Users\finli\AppData\Local\Temp\tmp8niuk4fj.js
  ...
  (() => {
    ...
    async function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = 'web/srb2ween.data';
      var REMOTE_PACKAGE_BASE = 'srb2ween.data';
    ...
    for (var file of metadata['files']) {
      ...
      async function processPackageData(arrayBuffer) {
        ...
        Module['removeRunDependency'](`fp ${name}`);
          ...
          Module['removeRunDependency']('datafile_web/srb2ween.data');
      }
      Module['addRunDependency']('datafile_web/srb2ween.data');
    ...
    loadPackage({"files": [{"filename": "/autoexec.cfg", "start": 0, "end": 44}, {"filename": "/config.cfg", "start": 44, "end": 2590}, {"filename": "/doom2.wad", "start": 2590, "end": 6517258}, {"filename": "/doom3.wad", "start": 6517258, "end": 7388930}, {"filename": "/gm.sf2", "start": 7388930, "end": 10597038}, {"filename": "/timidity.cfg", "start": 10597038, "end": 10597056}], "remote_package_size": 10597056});

  })();

// end include: C:\Users\finli\AppData\Local\Temp\tmp8niuk4fj.js
// include: C:\Users\finli\AppData\Local\Temp\tmpr9g4kdh7.js

    // All the pre-js content up to here must remain later on, we need to run
    // it.
    if ((typeof ENVIRONMENT_IS_WASM_WORKER != 'undefined' && ENVIRONMENT_IS_WASM_WORKER) || (typeof ENVIRONMENT_IS_PTHREAD != 'undefined' && ENVIRONMENT_IS_PTHREAD) || (typeof ENVIRONMENT_IS_AUDIO_WORKLET != 'undefined' && ENVIRONMENT_IS_AUDIO_WORKLET)) Module['preRun'] = [];
    var necessaryPreJSTasks = Module['preRun'].slice();
  // end include: C:\Users\finli\AppData\Local\Temp\tmpr9g4kdh7.js
// include: C:\Users\finli\AppData\Local\Temp\tmp_pccqz1y.js

    if (!Module['preRun']) throw 'Module.preRun should exist because file support used it; did a pre-js delete it?';
    necessaryPreJSTasks.forEach((task) => {
      if (Module['preRun'].indexOf(task) < 0) throw 'All preRun tasks that exist before user pre-js code should remain after; did you replace Module or modify Module.preRun?';
    });
  // end include: C:\Users\finli\AppData\Local\Temp\tmp_pccqz1y.js
...
function findWasmBinary() {
  return locateFile('srb2ween.wasm');
}
...
var ASM_CONSTS = {
 ...
 422392: ($0) => { if (Module['canvas']) { Module['canvas'].style['cursor'] = UTF8ToString($0); } },  
 422475: () => { if (Module['canvas']) { Module['canvas'].style['cursor'] = 'none'; } },  
 422544: () => { return window.innerWidth; },  
 422574: () => { return window.innerHeight; }
};
